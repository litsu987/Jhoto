...
class PokemonSummary_Scene
  ...
  def drawPageOne
    ...
    overlay = @sprites["overlay"].bitmap
    coords = (PluginManager.installed?("BW Summary Screen")) ? [220, 294] : [290, 390]
  ...
  def drawPageThree
    ...
    overlay = @sprites["overlay"].bitmap
    coords = (PluginManager.installed?("BW Summary Screen")) ? [110, 83] : [570, 110]
  ...
  def pbLegacyMenu    
    ...
    loop do
      ...
      if dorefresh
        ...
        textpos.push([_INTL("HISTÓRICO DE {1}", @pokemon.name.upcase), 320, ypos + 58, :center, base2, shadow2],
